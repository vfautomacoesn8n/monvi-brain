...
*Atualizado em 2026-08-17 (Task 088), após verificação direta do código, dos testes e das decisões formais — não apenas da documentação anterior desta seção.*
...
- embeddings e busca vetorial da Fase 7 (extração real de texto puro concluída na Task 087, extração real de PDF concluída na Task 090; Word/`.docx`, OCR de PDF digitalizado e embeddings/busca vetorial seguem pendentes);
