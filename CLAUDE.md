...
6. O workflow correspondente em [`00_SYSTEM/workflows/`](00_SYSTEM/workflows/README.md)

Este arquivo é apenas um adaptador. Não o trate como fonte oficial de regras.
